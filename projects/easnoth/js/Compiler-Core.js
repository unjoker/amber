...
$1=_st((function(){
return smalltalk.withContext(function($ctx2) {
return _st($DoIt())._temp_newWithMapIndex_($CWMap(),(5));
}, function($ctx2) {$ctx2.fillBlock({},$ctx1)})}))._value();
return $1;
}, function($ctx1) {$ctx1.fill(self,"xxxDoIt",{},smalltalk.DoIt)})},
args: [],
source: "xxxDoIt ^[DoIt temp: CWMap newWithMapIndex: 5.] value",
messageSends: ["value", "temp:newWithMapIndex:"],
referencedClasses: ["CWMap", "DoIt"]
}),
smalltalk.DoIt);


smalltalk.DoIt.klass.iVarNames = ['temp'];
smalltalk.addMethod(
smalltalk.method({
selector: "temp",
...
$1=self["@temp"];
return $1;
}, function($ctx1) {$ctx1.fill(self,"temp",{},smalltalk.DoIt.klass)})},
args: [],
source: "temp\x0a\x09^ temp",
messageSends: [],
referencedClasses: []
}),
smalltalk.DoIt.klass);
...
return smalltalk.withContext(function($ctx1) { 
self["@temp"]=temp1;
return self}, function($ctx1) {$ctx1.fill(self,"temp:",{temp1:temp1},smalltalk.DoIt.klass)})},
args: ["temp1"],
source: "temp: temp1\x0a\x09temp := temp1",
messageSends: [],
referencedClasses: []
}),
smalltalk.DoIt.klass);
